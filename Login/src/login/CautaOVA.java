 ...
 * @author Vladutz
 */
public class CautaOVA extends javax.swing.JFrame implements DocumentListener {
    ...
    public String[] returneazaCod(String text){
       ...
       // String a;
       // a=text.substring(0);
       rs1 = stmt.executeQuery("select OVA,Camere,Strada from aptvanzare where OVA Like '"+text+"%'");
       while(rs1.next()){
         Camere.add(  rs1.getString("Camere"));
         Strazi.add(rs1.getString("Strada"));
         String aux;
        aux= rs1.getString("OVA");
        Numere.add(aux);
       }
                ...
                for(int i=0;i<Camere.size();i++){
                    Numere1[i]="OVA "+Numere.get(i)+"|"+Camere.get(i)+" camere| Str. "+Strazi.get(i);
                }
                if (Numere1.length>0)
                return Numere1; else 
                    return null;
     ...
     public String[] returneazaStrada(String text){
       ...
       // System.out.println("db connected");
        ...
        ResultSet rs1;
       rs1 = stmt.executeQuery("select OVA,Camere,Strada from aptvanzare where Strada Like '"+text+"%'");
       while(rs1.next()){
         Camere.add(rs1.getString("Camere"));
         Strazi.add(rs1.getString("Strada"));
         String aux;
 ...
 try {
       ...
       conn = DriverManager.getConnection( "jdbc:mysql://localhost:3306/imobiliare", "razvan", "razvan");
        ...
        ResultSet rs1;
        System.out.println("select OVA,Zona,Reper,Strada,Camere,Compartimentare,SuprafataUtila,Etaj,Pret,Data "
                + "from aptvanzare"
                + " where  OVA>1"+String11+String12+String13+String14+String21+String22+String23+String24
                ...
                +Pret+Etaj+status+StringPublicate+anc+ " order by Data ");
        String rez;
        ...
        rs1 = stmt.executeQuery("select OVA,Zona,Reper,Strada,Camere,Compartimentare,SuprafataUtila,Etaj,Pret,Data,Poza,Imagine,Status "
                + "from aptvanzare"
                
                + " where  OVA>=1"+rez+String11+String12+String13+String14+String21+String22+String23+String24
                + String31+String32+String33+String34+String35+String41+String42+String43+String44+String45+String46
                + String51+String52+String53+String54+String61+String62+String63+Stringp1+String71+String72+String73
                + String81+String82+String83+StringMetrou+String91+String92+StringExclusivitate+StringParter+StringUltimul
                +Pret+Etaj+status+StringPublicate+anc+" order by Data ");
       ...
       int count=0;
        ...
        while (rs1.next()) {
            ...
            ListaTabelLinii.add(new ArrayList<Object>());
             ListaTabelLinii.get(count).add(rs1.getInt("OVA"));
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean isEditable, int row, int column)
    {
      ...
      jTable1.setDefaultRenderer(model.getColumnClass(2), a);
       ...
       jTable1.setModel(model);
        ...
        if (ListaTabelLinii.size()==0){
            JOptionPane.showMessageDialog(CautaOVA.this,"NU a fost gasit niciun rezultat pentru aceasta cautare","Error Message",JOptionPane.ERROR_MESSAGE);
            jTable1.setVisible(false);
        }
      //  
 }  catch(Exception e){
         ...
         DefaultTableCellRenderer a= new DefaultTableCellRenderer()
{
 ...
 try {
       ...
       conn = DriverManager.getConnection( "jdbc:mysql://localhost:3306/imobiliare", "razvan", "razvan");
        ...
        ResultSet rs1;
       stmt=conn.prepareStatement("select OVA,Zona,Reper,Strada,Camere,Compartimentare,SuprafataUtila,Etaj,Pret,Data,Poza,Imagine,Status "
                + "from aptvanzare"
                + " where  OVA = ?   order by Data");
       ...
       DefaultTableCellRenderer a= new DefaultTableCellRenderer()
{
    ...
    private void CautaDupaCodButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CautaDupaCodButtonActionPerformed
        ...
        //ListCod.setVisible(false);
            ...
            if(CautaDupaCodTextField.getText().isEmpty()){
                ...
                //if (CautaDupaCodTextField.getText().startsWith("OVA ")==false)
                 try{
            ...
            flagInt=true;
              ...
              if(flagInt==true){
            //this.PretLabel.setForeground(Color.red);
            JOptionPane.showMessageDialog(CautaOVA.this,"Va rugam sa introduceti un cod valid","Error Message",JOptionPane.ERROR_MESSAGE);
        }
}
 ...
 try {
       ...
       stmt=conn.prepareStatement("select OVA,Zona,Reper,Strada,Camere,Compartimentare,SuprafataUtila,Etaj,Pret,Data,Poza,Imagine,Status "
                + " from aptvanzare "
                + " where Strada Like '"+nume+ "%' order by Data");
       ...
       DefaultTableCellRenderer a= new DefaultTableCellRenderer()
{
 ...
 try {
       ...
       stmt=conn.prepareStatement("select OVA,Zona,Reper,Strada,Camere,Compartimentare,SuprafataUtila,Etaj,Pret,Data,Poza,Imagine,Status "
                + "from aptvanzare"
                + " where  Pret BETWEEN ? and ?  order by Data ");
       ...
       DefaultTableCellRenderer a= new DefaultTableCellRenderer()
{
  ...
  boolean ok=true; 
            ...
            flagInt=true;
              ...
              if(flagInt==true){
            //this.PretLabel.setForeground(Color.red);
            JOptionPane.showMessageDialog(CautaOVA.this,"Va rugam sa introduceti un pret minim valid","Error Message",JOptionPane.ERROR_MESSAGE);
        }
}
            if (ok==false){
                JOptionPane.showMessageDialog(CautaOVA.this,"Va rugam sa introduceti un pret minim valid","Error Message",JOptionPane.ERROR_MESSAGE);
            ...
            flagInt=true;
              ...
              if(flagInt==true){
            //this.PretLabel.setForeground(Color.red);
            JOptionPane.showMessageDialog(CautaOVA.this,"Va rugam sa introduceti un pret maxim valid","Error Message",JOptionPane.ERROR_MESSAGE);
        }
}
            if (ok==false){
                JOptionPane.showMessageDialog(CautaOVA.this,"Va rugam sa introduceti un pret maxim valid","Error Message",JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        this.setVisible(false);
            CautaOVA cautaOVA=new CautaOVA();
            cautaOVA.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CautaOVA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
