...
public class detaliiOVA extends javax.swing.JFrame {
   ...
   /* public afisare() {
    ...
    public void functie(int OVA){
       ...
       rs1 = stmt.executeQuery("select Agent,Status,Strada,Pret,Poza,Harta,DescriereEmotionala,Camere,Confort,Compartimentare,Etaj,EtajeTotale,"
               ...
               +" UsiIntrare,Imagine,"
                    ...
                    + "Sauna,"
               + "Reper,AdresaCompleta,Status from aptvanzare where OVA Like "+OVA+"");
       while(rs1.next()){
           ...
           //pentru poze
            byte[] imgData2 = rs1.getBytes("Harta");//Here r1.getBytes() extract byte data from resultSet 
             ...
             Detalii.setText("OVA "+OVA+" - Agent: "+Agent+" - Status: "+Status);
             String Strada="";
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(Dotari, javax.swing.GroupLayout.PREFERRED_SIZE, 963, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(AdaugaPoza, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(ModificaDetalii, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(31, 31, 31))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Utilitati, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
      ...
      PreparedStatement myStmt = null; 
       try{
          Class.forName("com.mysql.jdbc.Driver");
            ...
            myStmt = conn.prepareStatement("insert into comentariiva"
    ...
    private void ModificaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificaButtonActionPerformed
		...
		try {
                ...
                "jdbc:mysql://localhost:3306/imobiliare", "razvan", "razvan");
			// prepare statement
			myStmt = conn.prepareStatement("update aptvanzare"
					+ " set Pret=?, Stare=? "
					+ " where OVA=?");
			...
			// execute SQL
			myStmt.executeUpdate();	
                        JOptionPane.showMessageDialog(detaliiOVA.this, "Stare noua si Pret nou au fost modificate cu succes", "", JOptionPane.INFORMATION_MESSAGE);
		}
		catch(Exception e){
                    JOptionPane.showMessageDialog(detaliiOVA.this, "Error: " + e, "Error", JOptionPane.ERROR_MESSAGE);
                    e.printStackTrace();
                }
    ...
    private void AdaugaPozaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdaugaPozaActionPerformed
       JFileChooser fileChooser = new JFileChooser();
        ...
        if(imagine==1&&succes){
           PreparedStatement myStmt = null; 
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                myStmt = conn.prepareStatement("insert into pozeva (OVA,Poza,PrimaPoza) values (?,?,?)");
            ...
            Class.forName("com.mysql.jdbc.Driver");
                ...
                myStmt = conn.prepareStatement("update aptvanzare set Imagine=?, Poza=? where OVA="+parametru);
        ...
        new detaliiOVA(parametru).setVisible(true);
    ...
    private void ModificaDetaliiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificaDetaliiActionPerformed
        // TODO add your handling code here:
        new OVA(parametru).setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(detaliiOVA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
